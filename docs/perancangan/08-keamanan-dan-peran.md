...
|---|---|---|
| Membuka & menutup sesi kas | ✅ | ✅ |
| Melayani transaksi penjualan | ✅ | ✅ |
| Menggantung & melanjutkan transaksi | ✅ | ✅ |
| Melakukan retur | ✅ | ✅ |
| Menambah produk kilat saat transaksi | ✅ | ✅ |
| Mengisi stok fisik saat opname | ✅ | ✅ |
| **Melihat HPP dan laba** | ✅ | ❌ |
| **Mengubah harga jual** | ✅ | ❌ |
| Mengelola produk, satuan, kategori | ✅ | ❌ |
| Mengimpor CSV | ✅ | ❌ |
| Menyesuaikan stok manual | ✅ | ❌ |
| Memposting opname | ✅ | ❌ |
| Mengelola pemasok & pembelian | ✅ | ❌ |
| Menerima barang | ✅ | ❌ |
| Melihat laporan | ✅ | ❌ |
| Mengubah sandi sendiri | ✅ | ✅ |
| Mengelola akun pengguna (buat, nonaktifkan, atur ulang sandi) | ✅ | ❌ |
