...
|---|---|---|---|
| Jaringan putus saat menyimpan nota | Perangkat | Masuk antrean | 🔴 Offline · penjualan lanjut |
| Server tidak menjawab | Perangkat | Coba lagi dengan jeda menaik | 🟡 *n* menunggu |
| Nota ditolak (422) | Server | Hentikan percobaan, tandai | ⚠️ + alasan + tombol tindakan |
...
| Basis data tidak terjangkau | Server | `503`, jangan pura-pura berhasil | 🟡 antrean tetap aman |
